...
namespace Compiler.SemanticAnalysis
{
    ...
    public class DeclarationIdentifier
    {
        ...
        {
            PerformIdentification(ifCommand.IfCondition);
            PerformIdentification(ifCommand.IfCommand);
            PerformIdentification(ifCommand.ElseCommand);
        }

        private void PerformIdentificationOnIfUnlessCommand(IfUnlessCommandNode ifUnlessCommand)
        {
            PerformIdentification(ifUnlessCommand.IfCondition);
        ...
        private void PerformIdentificationOnWithCommand (WithCommandNode WithCommand)
        {
            ...
            PerformIdentification(WithCommand.Declaration);
            PerformIdentification(WithCommand.Command);
        ...
        {
            SymbolTable.OpenScope();
            PerformIdentification(letCommand.Declarations);
        ...
        private void PerformIdentificationOnIdentifierExpression(IdentifierExpressionNode idExpression)
        {
